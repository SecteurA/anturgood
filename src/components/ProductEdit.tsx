...
const ProductEdit: React.FC<ProductEditProps> = ({ onNavigateBack, product }) => {
  const [formData, setFormData] = useState({
    nom_produit: product.nom_produit,
    prix_achat: product.prix_achat.toString(),
    prix_vente: product.prix_vente.toString(),
    unite: product.unite || 'unite',
    dimension_standard: (product as any).dimension_standard?.toString() || '1'
  });
    ...
    <div className="min-h-full flex flex-col">
      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          ...
          <p className="text-gray-600 mt-1">Modifiez les informations du produit</p>
        </div>
      </div>
            ...
            {requiresDimension(formData.unite) && (
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">
                  Dimension standard par pièce. Exemple: une poutrelle de 3m
                </p>
              </div>
            )}
