...
const ClientEdit: React.FC<ClientEditProps> = ({ onNavigateBack, client }) => {
    ...
    try {
      ...
      if (error.code === '23505') {
        if (error.details?.includes('ice')) {
          setErrors({ ice: 'Ce numéro ICE est déjà utilisé par un autre client' });
        } else {
    ...
    <div className="min-h-full flex flex-col">
      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          ...
          <p className="text-gray-600 mt-1">Modifiez les informations du client {client.numero_client}</p>
        </div>
      </div>
            ...
            <div className="pt-6 border-t border-gray-200">
              <div className="flex justify-end gap-4">
                ...
                >
                  ...
                  {isSubmitting ? 'Enregistrement...' : 'Modifier le client'}
                </button>
              </div>
            </div>
          </form>
